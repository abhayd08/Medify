  ...
  return (
    ...
    >
      <form
        ...
        className="px-2 flex flex-wrap justify-center gap-y-5 items-center gap-[120px]"
      >
        <div
          className={`relative ${
          ...
          >
            ...
            {selectedState !== "State" ? (
              <>
                ...
                {cities.map((city) => {
                  return (
                    <option className="text-[#11181C]" key={city} value={city}>
                      {city}
                    </option>
                  );
                })}
      ...
      <div className="flex flex-col gap-[25px] px-2">
        ...
        <div className="flex gap-[21px] flex-wrap justify-center items-center">
          <div className="w-[203px] h-[153px] rounded-[8px] flex flex-col gap-[15px] justify-center items-center">
            <img
