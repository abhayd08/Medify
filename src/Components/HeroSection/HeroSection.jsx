export default () => {
  return (
    <div className="flex heroSection max-w-[1170px] justify-center items-center gap-y-16 flex-wrap px-3 mx-auto mt-[44px]">
      ...
      <div className="relative">
        <img
          src="/assets/hero.png"
          className="w-[380px] heroImage lg:w-[425px] xl:w-[525px] max-w-[92vw] h-auto"
          alt="Hero-Image"
        />
        <div
