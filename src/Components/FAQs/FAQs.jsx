...
export default () => {
  return (
    <div className="bg-white px-2 pt-[36px] pb-[30px] flex flex-col justify-center items-center gap-[45px]">
      <div>
        <h6 className="text-[#2AA7FF] font-semibold text-base leading-[27px] text-center">
          Get Your Answer
        </h6>
        <h4 className="text-[#1B3C74] mt-2 font-semibold text-[48px] leading-[60px] text-center">
