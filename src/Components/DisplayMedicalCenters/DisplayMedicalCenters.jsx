...
export default () => {
  ...
  return (
    <div className="max-w-[1170px] flex flex-col bg-blue-300 gap-6 px-2 mx-auto mt-[90px]">
      <div className="flex flex-col gap-3">
        <h4 className="font-medium text-2xl leading-[36px] text-black">
          {medicalCentersData.length} medical{" "}
          {medicalCentersData.length === 1 ? "center" : "centers"} available in{" "}
          {searchedLocation}
        </h4>
      ...
      <div className="max-w-[786px] gap-[25px] flex flex-col">
        ...
        <div className="rounded-[8px] py-[24px] gap-[8px] flex justify-center items-center bg-white">
          <div
            onClick={() => (currentPage > 1 ? setCurrentPage(1) : "")}
            className={`border-[1.17px] ${
              currentPage !== 1 ? "cursor-pointer text-black" : "text-[#DFDFDF]"
